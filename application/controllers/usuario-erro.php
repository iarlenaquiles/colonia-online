...
class usuario extends CI_Controller
{
    ...
    public function alterar_foto(){
        $this->usuario_model->update($_REQUEST['id'], array(
          'foto' => $_REQUEST['foto']));
          echo json_encode(array('classe' => 'acerto', 'msg' => "Foto atualizada com sucesso!", 'url' => base_url('usuarui/minhaconta')));
          exit();
    }
...
public function atualizar_foto(){
    if (!empty($_REQUEST['id'])) {
      $this->usuario_model->update('usuario', array(
          ...
          echo json_encode(array('classe' => 'acerto', 'msg' => "Foto do usuário atualizada com sucesso!", 'url' => base_url('usuario/minhaconta')));
          exit();
    }
}
