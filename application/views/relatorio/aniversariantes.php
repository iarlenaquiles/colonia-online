<section class="wrapper" style="background:#f1f2f7">
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">Relatório - Aniversariantes</b></header>
                <div class="panel-body">
                    <form id="formEditarProcesso" method="post" class="formProcesso" target="_blank" action="<?php echo base_url('relatorio/gerar_aniversariantes');?>">
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label for="tipo_processo">Mês*:</label>
                                        <select  name="mes" class="form-control m-bot15" id="mes" required >
