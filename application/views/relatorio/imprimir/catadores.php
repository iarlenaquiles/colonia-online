                  ...
                  <div class="widget-box">
                    ...
                    <p align="center"><?php echo '<img width="60" height="60" src="'.base_url($dadosColonia['foto']).'"/>';?></p>
                      <div class="widget-title">
                          <h4 style="text-align: center">Catadores</h4>
                      </div>
                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr>
                              ...
                              <th style="font-size: 1.2em; padding: 5px;">SEAP</th>
                              <th style="font-size: 1.2em; padding: 5px;">MPA</th>
                              <th style="font-size: 1.2em; padding: 5px;">Profissão</th>
                          </tr>
                      </thead>
                      <tbody>
                          <?php
                          foreach ($catadores as $a) {

                              echo '<tr>';
                              echo '<td>' . $a['nome_pessoa'] . '</td>';
                              echo '<td>' . $a['cpf_cnpj'] . '</td>';
                              echo '<td>' . $a['numero_seap'] . '</td>';
                              echo '<td>' . $a['carteira_mpa'].'</td>';
                              echo '<td>' . $a['profissao_atual'] . '</td>';
                              echo '</tr>';
                          }
                          ?>
                      </tbody>
