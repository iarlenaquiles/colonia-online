                  ...
                  <div class="widget-box">
                    ...
                    <p align="center"><?php echo '<img width="60" height="60" src="'.base_url($dadosColonia['foto']).'"/>';?></p>
                      <div class="widget-title">
                          <h4 style="text-align: center">CPF, NIT e NASCIMENTO</h4>
                      </div>
                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr>
                              ...
                              <th style="font-size: 1.2em; padding: 5px;">NIT</th>
                              <th style="font-size: 1.2em; padding: 5px;">NASC</th>
                          </tr>
                      </thead>
                      <tbody>
                          <?php
