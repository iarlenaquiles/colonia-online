                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr>
                              ...
                              <th style="font-size: 1.2em; padding: 5px;">Data Filiação</th>
                              <th style="font-size: 1.2em; padding: 5px;">Aposentado</th>
                          </tr>
                      </thead>
                      <tbody>
                          <?php
                          foreach ($pescadores as $a) {

                              echo '<tr>';
                              echo '<td>' . $a['nome_pessoa'] . '</td>';
                              echo '<td>' . $a['cpf_cnpj'] . '</td>';
                              echo '<td>' . date('d/m/Y', strtotime($a['data_filiacao'])). '</td>';
                              echo '<td>' . $a['aposentado'] . '</td>';
                              echo '</tr>';
                          }
                          ?>
                      </tbody>
                  </table>
                  Total: <?php echo count($pescadores);?>
                  </div>
