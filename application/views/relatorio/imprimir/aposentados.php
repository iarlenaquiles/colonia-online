                  ...
                  <div class="widget-box">
                    ...
                    <p align="center"><?php echo '<img width="60" height="60" src="'.base_url($dadosColonia['foto']).'"/>';?></p>
                      <div class="widget-title">
                          <h4 style="text-align: center">Aposentados</h4>
                      </div>
                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr>
                              ...
                              <th style="font-size: 1.2em; padding: 5px;">Número Benefício</th>
                              <th style="font-size: 1.2em; padding: 5px;">Data da Aposentadoria</th>

                          </tr>
                      </thead>
                      <tbody>
                          <?php
                          foreach ($aposentados as $a) {

                              echo '<tr>';
                              echo '<td>' . $a['nome_pessoa'] . '</td>';
                              echo '<td>' . $a['nb_aposentadoria'] . '</td>';
                              echo '<td>' . $a['data_aposentadoria']. '</td>';
                              echo '</tr>';
                          }
                          ?>
                      </tbody>
