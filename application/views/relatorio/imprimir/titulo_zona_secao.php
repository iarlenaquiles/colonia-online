                  ...
                  <div class="widget-box">
                    ...
                    <p align="center"><?php echo '<img width="60" height="60" src="'.base_url($dadosColonia['foto']).'"/>';?></p>
                      <div class="widget-title">
                            <h4 style="text-align: center">TÍTULO, SEÇÃO E ZONA</h4>
                      </div>
                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr>
                              ...
                              <th style="font-size: 1.2em; padding: 5px;">Seção</th>
                              <th style="font-size: 1.2em; padding: 5px;">Zona</th>
                          </tr>
                      </thead>
                      <tbody>
                          <?php
                          foreach ($documentos as $a) {
                              ...
                              echo '<td>' . $a['num_titulo'] . '</td>';
                              echo '<td>' . $a['secao_titulo'] . '</td>';
                              echo '<td>' . $a['zona_titulo'] . '</td>';
                              echo '</tr>';
                          }
                          ?>
                      </tbody>
