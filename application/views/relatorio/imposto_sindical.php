<section class="wrapper" style="background:#f1f2f7">
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">Relatório - Imposto Sindical</b></header>
                <div class="panel-body">
                    <form id="formEditarProcesso" method="post" class="formProcesso" target="_blank" action="<?php echo base_url('relatorio/gerar_imposto/');?>">
                        <fieldset>
                            <legend>Imposto Sindical</legend>

                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label for="tipo_processo">Ano*:</label>
                                          <input type="text" class="form-control" required name="ano" placeholder="Informe o ano" >
                                    </div>
                                </div>
