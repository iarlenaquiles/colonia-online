...
<section class="wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">Agendamento INSS</header>
                          ...
                          <div class="col-lg-5">
                              <div class="form-group">
                                  ...
                                  <div>
                                      ...
                                      <input type="text" placeholder="" id="nome_pescador" required="true" name="nome_pescador" style="width:82%;margin-right:4px ; float:left;" class="form-control">
                                  </div>
                              </div>
                          </div>
