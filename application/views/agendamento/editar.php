...
<section class="wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">Editar Agendamento INSS</header>
...
<fieldset>
  <legend>Dados</legend>
  <input type="hidden" name="id_agendamento_inss" value="<?php echo $registro['id_agendamento_inss']; ?>" />
                        <div class="row">
                          <div class="col-lg-2">
                          ...
                          <div class="col-lg-5">
                              <div class="form-group">
                                  ...
                                  <div>
                                    ...
                                    <input type="text" placeholder="" id="nome_pescador" required name="nome_pescador" style="width:82%;margin-right:4px ; float:left;" class="form-control" value="<?php echo $registro['nome_pessoa'];?>"/>
                          ...
                          <div class="col-lg-4">
                              <div class="form-group">
                                  <label for="">Numero do benefício:</label>
                                  <input type="text" class="form-control" name="numero_beneficio" value="<?php echo $registro['numero_beneficio']; ?>" id="numero_beneficio" placeholder="">
                              </div>
                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tipo_beneficio" value="<?php echo $registro['tipo_beneficio']; ?>" id="tipo_beneficio" placeholder="">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control data" name="data_agendamento" id="data_agendamento" value="<?php echo date('d/m/Y H:i:s', strtotime($registro['data_cadastro'])); ?>" placeholder="" >
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">Horário:</label>
                                    <input type="text" class="form-control" name="horario" id="horario" value="<?php echo $registro['horario']; ?>" />
                                </div>
                            </div>
    ...
    $(document).ready(function(){
      ...
      $( "#nome_pescador" ).autocomplete({
        ...
        $("#formCadastro").submit(function(e){
            ...
            $.ajax({type:'POST',
                dataType: "json",url:'<?php echo base_url("agendamento/salvar");?>', data: dadosForm, success: function(response) {
