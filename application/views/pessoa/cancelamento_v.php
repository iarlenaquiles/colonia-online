          ...
          <div class="row" id="modeloPdf" style="">
              <div class="col-lg-12">
                  <div class="form-group">
                      <label for="">Pedido de Cancelamento</label>
                      ...
                      <head>
                      	...
                      	<title>Pedido de Cancelamento</title>
                      ...
                      <p align="center" class="um">
                      	  <font size="3" style="font-size: 12pt">PEDIDO DE CANCELAMENTO</font>
                      </p>
                      ...
                      CPF nº: <b><?php echo ($registro['cpf_cnpj']); ?></b>, residente e
                      ...
                      na <?php
                      echo $dadosColonia['nome_colonia'];
                      ?>, situada <?php echo ($dadosColonia['endereco_rua']);?>, <?php echo ($dadosColonia['endereco_numero']);?>, <?php echo ($dadosColonia['endereco_bairro']);?>, <?php
                      	...
                      	?>, CEP: <?php echo $registro['cep'];?> desde <b><?php echo date('d/m/Y', strtotime($registro['data_filiacao'])); ?></b>,
                      livro de n°: <b><?php echo ($registro['numero_livro_filiacao']);?></b>,
                      folha de n°: <b><?php echo ($registro['numero_folha_filiacao']);?></b> no
                      registro sob o n°: <b><?php echo ($registro['numero_carteira']);?></b>, <b><u>SOLICITO O CANCELAMENTO DE MINHA MATRÍCULA</u></b> nesta Colônia pelo motivo de estar fora da atividade da pesca, portanto estou enviando o mesmo a esta superintendência.</b></font></p>
...
<br>
    ...
    <form id="tipo">
    <input type="hidden" name="tipo_relatorio" value="Pedido de cancelamento" id="tipo_relatorio">
