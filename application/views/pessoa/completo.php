<section class="wrapper">
  ...
  <div class="row">
    <div class="col-lg-13">
      <section class="panel">
        <header class="panel-heading">Dados do Pescador n° <?php echo $registro['numero_carteira']; ?> - <?php echo $registro['nome_pessoa']; ?></header>
        <div class="panel-body">
          <div style="display:none">
            <form id="frmFoto" method="post" action="<?php echo base_url("pessoa/upload_foto"); ?>" enctype="multipart/form-data">
              <input id="uploadfoto" disabled name="uploadfoto" type="file" onchange="$('.foto-avatar').prepend('<div class=\'load\'></div>');$('#frmFoto').submit()" />
            </form>
                ...
                <div class="tab-pane active" id="audiencias">
                  <fieldset>
                      ...
                      <div class="col-xs-4 col-lg-2">
                        ...
                        <?php if(empty($registro['foto'])) {
                          ...
                          <div class="form-group">
                            ...
                            <input type='hidden' disabled name='foto' value="" id="avatar_cadastros" >
                          </div>
                        </div>
                        <?php
                      }else{
                        ?>
                        <div class="form-group">
                          <div style="position: absolute; margin: 0px 20px; background: transparent url(<?php echo base_url($registro['foto']);?>) no-repeat scroll center center / 150% auto; border: 5px solid rgb(194, 194, 194);"  class="foto-avatar arredonda-100 " >
                            <input type="hidden" disabled id="avatar_cadastros" value="<?php echo $registro['foto'];?>" name="foto">
                    ...
                    <div class="col-xs-4 col-lg-2">
                      <div class="form-group">
                        <label for="">CPF:</label>
                        <input type="text" disabled class="form-control" name="cpf_cnpj" value="<?php echo $registro['cpf_cnpj'];?>" id="cpf_cnpj" placeholder="" >
                      </div>
                    </div>
                    ...
                    <div class="col-xs-4 col-lg-8">
                      <div class="form-group">
                        ...
                        <input type="text" disabled class="form-control" name="nome" value="<?php echo $registro['nome_pessoa']; ?>" placeholder="Informe o Nome" required>
                      </div>
                    </div>
                  </div><br><br>
                  <div class="row">
                    ...
                    <div class="col-lg-2">
                      <div class="form-group">
                        ...
                        <input type="text" disabled class="form-control" name="apelido" value="<?php echo $registro['apelido']; ?>" placeholder="Informe o Apelido" >
                      </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                      <div class="form-group">
                        ...
                        <input type="text" disabled class="form-control data" name="data_nascimento" value="<?php if(!empty($registro['data_nascimento']) && '00/00/0000' != $registro['data_nascimento']) echo $registro['data_nascimento']; ?>" id="data_nascimento" placeholder="" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-2">
                      <div class="form-group">
                        ...
                        <select class="form-control m-bot15" name="estado_civil" id="estado_civil" disabled>

                          <option value="<?php echo $registro['estado_civil']; ?>" ><?php echo $registro['estado_civil']; ?></option>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled name="nome_mae" value="<?php echo $registro['nome_mae']; ?>" id="nome_mae" placeholder="" >
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label for="">Nome do Pai:</label>
                        <input type="text" class="form-control" disabled name="nome_pai" value="<?php echo $registro['nome_pai']; ?>" id="nome_pai" placeholder="" >
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-lg-2">
                      <div class="form-group">
                        ...
                        <select class="form-control m-bot15" name="pessoas" id="pessoas" onchange="Redireciona(this)">
                          ...
                          <option value="<?php echo base_url('pessoa/declaracao_test_view')."/".$registro['id_pessoa'];?>">Declaração com Testemunha</option>
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="nome_esposa" id="nome_esposa" value="<?php echo $registro['nome_esposa']; ?>" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label for="">E-mail:</label>
                            <input type="text" class="form-control" disabled name="email" value="<?php echo $registro['email']?>" id="email" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="exampleInputEmail1">Grau de estudo:</label>
                            <input type="text" class="form-control" disabled name="grau_estudo" value="<?php echo $registro['grau_estudo']?>" id="grau_estudo" placeholder="">
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="radio" name="alfabetizado" disabled value="Nao" <?php if('Nao' == $registro['alfabetizado']) echo "checked"; ?> /> Não
                            <input type="radio" name="alfabetizado" disabled value="Sim" <?php if('Sim' == $registro['alfabetizado']) echo "checked"; ?>  /> Sim
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-md-7"><label for="">Filhos:</label>
                            <textarea class="wysihtml5 form-control" disabled name="nome_filhos" rows="5"><?php echo $registro['nome_filhos']; ?></textarea>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled  name="nacionalidade" value="<?php echo $registro['nacionalidade']; ?>" id="nacionalidade" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">Naturalidade:</label>
                            <input type="text" class="form-control "  disabled name="naturalidade" value="<?php echo $registro['naturalidade']; ?>" id="naturalidade" placeholder="" >
                          </div>
                        </div>
                        <?php
                        // Declara a data! :P
                    ...
                    <fieldset>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">CEP:</label>
                            <input type="text" class="form-control cep" disabled value="<?php echo $registro['cep']; ?>" name="endereco_cep" id="Cep" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <select class="form-control m-bot15" disabled name="id_estado" id="id_estado" >
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <select class="form-control m-bot15" id="cidades" disabled name="id_cidade" style="background:#fff;opacity:0.65;" >
                            </select>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="endereco_logradouro" value="<?php echo $registro['endereco_logradouro']; ?>" id="endereco_logradouro" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-2">
                          <div class="form-group">
                            <label for="">Número:</label>
                            <input type="text" class="form-control" disabled name="endereco_numero" value="<?php echo $registro['endereco_numero']; ?>" id="endereco_numero" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label for="">Bairro:</label>
                            <input type="text" class="form-control"  disabled name="endereco_bairro" value="<?php echo $registro['endereco_bairro']; ?>" id="endereco_bairro" placeholder="" >
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-5">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="endereco_complemento" value="<?php echo $registro['endereco_complemento']; ?>" id="endereco_complemento" placeholder="" >
                          </div>
                        </div>
                      </div>
                    </fieldset>
                        ...
                        <div class="col-lg-10">
                          <div class="form-group">
                            <div class="col-md-8"><label for="">Telefones:</label>
                              <textarea class="wysihtml5 form-control" name="telefones" disabled  rows="2"><?php echo $registro['telefones']; ?></textarea>
                            </div>
                          </div>
                        </div>
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-10">
                          <div class="form-group">
                            <div class="col-md-8"><label for="">Vizinhos:</label>
                              <textarea class="wysihtml5 form-control" name="vizinhos"  disabled rows="2"><?php echo $registro['vizinhos']; ?></textarea>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="livro_reg_nasc" value="<?php echo $registro['reg_nasc_livro']; ?>" id="livro_reg_nasc" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label for="">Numero de registro de nascimento:</label>
                            <input type="text" class="form-control" disabled name="num_reg_nasc" value="<?php echo $registro['reg_nasc_numero']; ?>" id="num_reg_nasc" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">Folha de registro de nascimento:</label>
                            <input type="text" class="form-control" disabled name="folha_reg_nasc" value="<?php echo $registro['reg_nasc_folha']; ?>" id="folha_reg_nasc" placeholder="" >
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="num_titulo" value="<?php echo $registro['num_titulo']; ?>" id="num_titulo" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">Zona do título:</label>
                            <input type="text" class="form-control" disabled name="zona_titulo" value="<?php echo $registro['zona_titulo']; ?>" id="zona_titulo" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">Seção do título:</label>
                            <input type="text" class="form-control" disabled name="secao_titulo" value="<?php echo $registro['secao_titulo']; ?>" id="secao_titulo" placeholder="" >
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-2">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="numero_rg" id="numero_rg" value="<?php echo $registro['numero_rg']; ?>"placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">Orgão de Expedição RG:</label>
                            <input type="text" class="form-control " disabled name="orgao_expedicao_rg" value="<?php echo $registro['orgao_expedicao_rg']; ?>" id="orgao_expedicao_rg" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-2">
                          <div class="form-group">
                            <label for="">Data Expedição RG*:</label>
                            <input type="text" class="form-control data" disabled name="data_expedicao_rg" value="<?php if($registro['data_expedicao_rg'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_expedicao_rg'])); }?>" id="data_expedicao_rg" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <select class="form-control m-bot15" name="estado_expedicao_rg" disabled >
                              <option value="">SELECIONE ESTADO</option>
                              <?php
                              foreach($estados as $estado){
                                ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-2">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled value="<?php echo $registro['numero_ctps']; ?>" name="numero_ctps" id="numero_ctps" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-2">
                          <div class="form-group">
                            <label for="">Série CTPS*:</label>
                            <input type="text" class="form-control" disabled value="<?php echo $registro['serie_ctps']; ?>" name="serie_ctps" id="serie_ctps" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <select class="form-control m-bot15" name="estado_emissao_ctps" disabled>
                              <option value="">SELECIONE ESTADO</option>
                              <?php
                              foreach($estados as $estado){
                                ?>
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled value="<?php echo $registro['num_reservista']; ?>" name="num_reservista" id="num_reservista" placeholder="" >
                          </div>
                        </div>
                      </div>
                    </fieldset>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-2">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="numero_carteira" id="numero_carteira" value="<?php echo $registro['numero_carteira'];?>" placeholder="" >
                          </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control data" disabled name="data_filiacao" value="<?php if($registro['data_filiacao'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_filiacao'])); }?>" id="data_filiacao" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">Número do livro de filiação:</label>
                            <input type="text" class="form-control" disabled name="numero_livro_filiacao" value="<?php echo $registro['numero_livro_filiacao'];?>" id="numero_livro_filiacao" placeholder="" >
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="numero_folha_filiacao" value="<?php echo $registro['numero_folha_filiacao'];?>" id="numero_folha_filiacao" placeholder="" >
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            ?>
                            <input type="text" class="form-control" disabled name="tempo_filiacao" value="<?php   echo $idade.' anos, '.$mes.' m&ecirc;s(es), '.$dias.' dias'; ?>" id="tempo_filiacao" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
                            <label for="">Profissão Atual:</label>
                            <input type="text" class="form-control" disabled name="profissao_atual" value="<?php echo $registro['profissao_atual'];?>" id="profissao_atual" placeholder="" >
                          </div>
                        </div>
                      </div>
                    </fieldset>
                  ...
                  <div class="tab-pane" id="recurso_contestacao">
                    <fieldset>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="numero_carteira_sudepe" value="<?php echo $registro['numero_carteira_sudepe'];?>"  id="numero_carteira_supede" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-2">
                          <div class="form-group">
                            <label for="">Data SUDEPE:</label>
                            <input type="text" class="form-control data"  disabled name="data_expedicao_sudepe" value="<?php if($registro['data_expedicao_supede'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_expedicao_supede'])); }?>" id="data_expedicao_sudepe" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">N° SEAP:</label>
                            <input type="text" class="form-control" disabled name="numero_seap" value="<?php echo $registro['numero_seap'];?>" id="numero_seap" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-2">
                          <div class="form-group">
                            <label for="">Data SEAP:</label>
                            <input type="text" class="form-control data" disabled name="data_expedicao_seap" value="<?php if($registro['data_expedicao_seap'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_expedicao_seap'])); }?>" id="data_expedicao_seap" placeholder="" >
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="numero_pis" value="<?php echo $registro['numero_pis'];?>" id="numero_pis" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-2">
                          <div class="form-group">
                            <label for="">Data Inscrição PIS:</label>
                            <input type="text" class="form-control data" disabled name="data_expedicao_pis" value="<?php if($registro['data_expedicao_pis'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_expedicao_pis'])); }?>" id="data_expedicao_pis" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">Inscrição NIT:</label>
                            <input type="text" class="form-control" disabled name="numero_nit" value="<?php echo $registro['numero_nit'];?>" id="numero_nit" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-2">
                          <div class="form-group">
                            <label for="">Data Inscrição NIT:</label>
                            <input type="text" class="form-control data" disabled name="data_expedicao_nit" value="<?php if($registro['data_expedicao_nit'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_expedicao_nit'])); }?>" id="data_expedicao_nit" placeholder="" >
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="numero_cei" value="<?php echo $registro['numero_cei'];?>" id="numero_cei" placeholder="" >
                          </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control data" disabled value="<?php if($registro['data_expedicao_cei'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_expedicao_cei'])); }?>" name="data_expedicao_cei" id="data_expedicao_cei" placeholder="" >
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="radio" name="morto" disabled value="Nao" <?php if('Nao' == $registro['morto']) echo "checked"; ?> /> Não
                            <input type="radio" name="morto" disabled value="Sim"  <?php if('Sim' == $registro['morto']) echo "checked"; ?> /> Sim
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="radio"  name="amador" disabled value="Nao"   <?php if('Nao' == $registro['amador']) echo "checked"; ?>/> Não
                            <input type="radio" name="amador" disabled value="Sim"  <?php if('Sim' == $registro['amador']) echo "checked"; ?>/> Sim
                          </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="numero_capitania_portos" value="<?php echo $registro['numero_capitania_portos'];?>" id="numero_capitania_portos" placeholder="" >
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control data" disabled name="data_inscricao_capitania" value="<?php if($registro['data_inscricao_capitania'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_inscricao_capitania'])); }?>"  id="data_inscricao_capitania" placeholder="" >
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="carteira_mpa" value="<?php echo $registro['carteira_mpa'];?>" id="carteira_mpa" placeholder="" >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">Data Expedição MPA:</label>
                            <input type="text" class="form-control data" disabled name="data_expedicao_mpa" value="<?php if($registro['data_expedicao_mpa'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_expedicao_mpa'])); }?>" id="data_expedicao_mpa" placeholder="" >
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            <label for="">Aposentado(a):</label>
                            <input type="radio"  name="aposentado" disabled value="Nao"  <?php if('Nao' == $registro['aposentado']) echo "checked"; ?> /> Não
                            <input type="radio" name="aposentado" disabled value="Sim"  <?php if('Sim' == $registro['aposentado']) echo "checked"; ?>/> Sim
                          </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control data" disabled value="<?php if($registro['data_aposentadoria'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_aposentadoria'])); }?>" name="data_aposentadoria" id="data_aposentadoria" placeholder="" >
                          </div>
                        </div>
                        ...
                        <div class="col-lg-5">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="nb_aposentadoria" id="nb_aposentadoria" value="<?php echo $registro['nb_aposentadoria'];?>" placeholder="" >
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-5">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled value="<?php echo $registro['carteira_mapa'];?>" name="carteira_mapa" id="carteira_mapa" placeholder="" >
                          </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control data" disabled name="data_mapa" value="<?php if($registro['data_mapa'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_mapa'])); }?>" id="data_mapa" placeholder="" >
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="radio"  name="transferido" disabled value="Nao"  <?php if('Nao' == $registro['transferido']) echo "checked"; ?> /> Não
                            <input type="radio" name="transferido" disabled value="Sim"  <?php if('Sim' == $registro['transferido']) echo "checked"; ?>/> Sim
                          </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control data" disabled name="data_transferencia" value="<?php if($registro['data_transferencia'] == '0000-00-00'){ echo "00/00/0000";}else{ echo date('d/m/Y', strtotime($registro['data_transferencia'])); }?>" id="data_transferencia" placeholder="" >
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                          <div class="col-md-7"><label for="">Tipo de Pescado:</label>
                            <textarea class="wysihtml5 form-control" disabled name="tipo_pescado"  rows="5"><?php echo $registro['tipo_pescado'];?></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="form-group">
                          <div class="col-md-7"><label for="">Observações:</label>
                            <textarea class="wysihtml5 form-control" disabled name="observacoes"  rows="5"><?php echo $registro['observacoes'];?></textarea>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="numero_embarcacao" value="<?php echo $registro['numero_embarcacao'];?>" id="numero_embarcacao" placeholder="" >
                          </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="nome_embarcacao" value="<?php echo $registro['nome_embarcacao'];?>" id="nome_embarcacao" placeholder="" >
                          </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="tamanho_embarcacao" value="<?php echo $registro['tamanho_embarcacao'];?>" id="tamanho_embarcacao" placeholder="" >
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" disabled name="largura_embarcacao" value="<?php echo $registro['largura_embarcacao'];?>" id="largura_embarcacao" placeholder="">
                          </div>
                        </div>
                      </div>
          ...
          <?php if(($this->permission->checkPermission($this->session->userdata('permissao'),'vPagamento'))){ ?>
            ...
            <div class="modal-dialog" style="width:400px;">
              ...
              <div class="modal-content">
                <form action="" id="formAddPagamentoEditar">
  ...
  $(document).ready(function(){
    ...
    $("#formAddPagamento").submit(function (e) {
      ...
      $.ajax({
        type: 'POST',
        dataType: "json",
        url: '<?php echo base_url("pessoa/salvar_pagamento_c");?>',
        data: dadosForm,
        success: function (response) {
          if ('erro' == response.classe) {
            $('#loader-wrapper').fadeOut(500);
    ...
    $("#formAddPagamentoEditar").submit(function (e) {
      ...
      $.ajax({
        type: 'POST',
        dataType: "json",
        url: '<?php echo base_url("pessoa/atualizar_pagamento_c");?>',
        data: dadosForm,
        success: function (response) {
          if ('erro' == response.classe) {
            $('#loader-wrapper').fadeOut(500);
    ...
    $("#formAddAnexo").submit(function (e) {
      ...
      $.ajax({
        type: 'POST',
        dataType: "json",
        url: '<?php echo base_url("pessoa/salvar_anexo");?>',
        data: dadosForm,
        success: function (response) {
  ...
  $(document).ready(function(){
    ...
    $("#formAddAtendimento").submit(function (e) {
      ...
      $.ajax({
        type: 'POST',
        dataType: "json",
        url: '<?php echo base_url("pessoa/salvar_historico");?>',
        data: dadosForm,
        success: function (response) {
    ...
    $("#formAddAgendamento").submit(function (e) {
      ...
      $.ajax({
        type: 'POST',
        dataType: "json",
        url: '<?php echo base_url("pessoa/salvar_agendamento");?>',
        data: dadosForm,
        success: function (response) {
