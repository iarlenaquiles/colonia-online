              ...
              <div class="col-lg-12">
                  <div class="form-group">
                      ...
                      <p align="center" class="um">
                      	  <font size="3" style="font-size: 12pt"><b>TRANSFERÊNCIA</b></font>
                      </p>
<br>
                      <p align="justify" class="um" style="line-height: 1.5;  text-indent: 80px">
                      <font size="3" style="font-size: 12pt;">Eu,  <b><u><?php
...
presidente da <b><?php echo $dadosColonia['nome_colonia']; ?></b>, situada <?php echo ($dadosColonia['endereco_rua']);?> , <?php echo strtoupper($dadosColonia['endereco_numero']);?>, <?php echo strtoupper($dadosColonia['endereco_bairro']);?>,
                      		<?php
                      	...
                      	?>, CEP: <?php echo $registro['cep'];?>, venho através deste e a pedido de <b><u><?php echo ($registro['nome_pessoa']);?></u></b>, estado civil <b><?php echo ($registro['estado_civil']);?></b>,
                      ...
                      portador(a) do CPF: <b><?php echo ($registro['cpf_cnpj']); ?></b>, portador do NIT sob o nº <?php echo ($registro['numero_nit']);?></b>, CEI de nº <b><?php echo ($registro['numero_cei']);?></b>, residente e domiciliado(a) <b><?php echo ($registro['endereco_logradouro']);?></b>, n°
                      ...
                      pede a transferência para a Colônia XXX e que o mesmo se encontra com suas contribuições em dias.<br>
                      </font></p>

                      <p align="justify" class="um" style="line-height: 1.5;  text-indent: 80px">
                      <font size="3" style="font-size: 12pt;">Nada mais havendo a declarar para que se tomem seus efeitos legais.</font></p>
...
?>
    ...
    <form id="tipo">
    <input type="hidden" name="tipo_relatorio" value="Declaração" id="tipo_relatorio">
